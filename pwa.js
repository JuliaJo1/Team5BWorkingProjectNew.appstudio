...
const cacheName = 'Team5BWorkingProjectNew-2020-11-16 15:40:39.704054'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, 'Team5BWorkingProjectNew'.length) === 'Team5BWorkingProjectNew') {
